...
//            try
//            {
//                _context.Log_status.Add(statusLog);
...
//        {
//            var data = _context.Log_status.FirstOrDefault(x => x.UUID == uuid);
//            if (data != null)
//            {
//                _context.Log_status.Remove(data);
//                _context.SaveChanges();
//                return new ResBase<StatusLog>()
//                {
//                    Data = null,
...
//        {
//            var data = _context.Log_status.ToList();
...
//            var dataApplied = _context.Trn_applied_program.FirstOrDefault(ap => ap.UUID == data.IdAppliedProgram);
//            if (dataApplied != null)
//            {
